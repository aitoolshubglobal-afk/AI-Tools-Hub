...
export const tools: Tool[] = [
  {
    ...
    badge: "Featured pick", badgePt: "Destaque", description: "An AI toolbox for YouTube ideas, scripts, titles, tags, descriptions, and channel growth.", descriptionPt: "Uma caixa de ferramentas de IA para ideias, roteiros, títulos, tags, descrições e crescimento no YouTube.", rating: "4.8", price: "$41 / month*", bestFor: "YouTube growth", bestForPt: "Crescimento no YouTube", highlight: "Recurring affiliate offer", highlightPt: "Oferta de afiliado recorrente", href: "https://tubemagic.com/ds#aff=gideonicruz110e", color: "lime", website: "https://tubemagic.com/", tags: ["youtube", "content", "writing"], pros: ["Focused YouTube workflow", "Covers ideation through metadata", "Useful for repeatable publishing"], cons: ["Niche if you do not publish on YouTube", "Pricing should be checked before purchase"], features: ["Ideas", "Scripts", "Titles", "Tags", "Descriptions"], alternatives: ["descript"], scores: { usefulness: 9, ease: 9, quality: 8, value: 8 }, lastReviewed: "2026-09-09"
  },
  {
